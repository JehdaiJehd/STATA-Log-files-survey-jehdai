...
clear
log using "$log\apbs_tab_verif", text replace
...
gen in_23413 = 0 if i10_0_wcobs == 1
replace in_23413 = 1 if i10_1_odeur == 0 & i10_2_mouches == 0 & i10_3_propre == 1 & i10_4_couvercle == 1 & i10_5_couvercle == 0 & I10_6_fissures = 0
