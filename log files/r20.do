...
global source "G:\Drive partagés\DRC - MEL FSP\05 Data System Reports\5.15 AM - Enquête annuelle\5.15.4 2022-08 APBS\05_data\05.3_final" // source data
global syntax "G:\Drive partagés\DRC - MEL FSP\05 Data System Reports\5.15 AM - Enquête annuelle\5.15.4 2022-08 APBS\06_analysis\06.2_syntax" // syntax
global log "G:\Drive partagés\DRC - MEL FSP\05 Data System Reports\5.15 AM - Enquête annuelle\5.15.4 2022-08 APBS\06_analysis\06.3_log_files" // log file
global results "G:\Drive partagés\DRC - MEL FSP\05 Data System Reports\5.15 AM - Enquête annuelle\5.15.4 2022-08 APBS\06_analysis\06.4_analytic_outputs" // analytic outputs

clear
log using "$log\apbs_tab_r20", text replace
...
*IN r_20_P2 % of households who have and use hygienic toilets : Must be add in apbs_comp

gen r_20b = 0 if i10_1_odeur == 0 | i10_1_odeur == 1 | i10_2_mouches == 0 | i10_2_mouches == 1 | i10_3_propre == 0 | i10_3_propre == 1 | i10_4_couvercle == 0 | i10_4_couvercle == 1

replace r_20b = 1 if i10_1_odeur == 0 & i10_2_mouches == 0 & i10_3_propre == 1

svy: mean r_20b
svy: mean r_20b if health_zone == "kalehe"
svy: mean r_20b if health_zone == "katana"
svy: mean r_20b if health_zone == "miti_murhesa"

*IN r_20_1 % of households who actually had toilets : Must be add in apbs_comp

gen r_20_1b = 0 if i07_instalsan <= 10

replace r_20_1b = 1 if i07_instalsan <= 10 & i07_instalsan >= 1

svy: mean r_20_1b
svy: mean r_20_1b if health_zone == "kalehe"
svy: mean r_20_1b if health_zone == "katana"
svy: mean r_20_1b if health_zone == "miti_murhesa"

* IN 2.3.4.0.1  % of households with soap and water at a handwashing station commonly used by family members

gen in_23401 = 0 if i06_installavmains <= 3 & i06_installavmains >= 1

replace in_23401 = 1 if i06_installavmains == 2

svy: mean in_23401

svy: mean in_23401 if health_zone == "kalehe"
svy: mean in_23401 if health_zone == "katana"
svy: mean in_23401 if health_zone == "miti_murhesa"
...
gen in_23001b = 0 if smplfrm_cg == 1
replace in_23001b = f3_1_pct_chn_diarrhea if f3_1_pct_chn_diarrhea > 0
svy: mean in_23001b

* IN 2.3.1.0.3  % CU5 with diarrhea treated with ORT

gen in_23103b = 0 if f3_1_pct_chn_diarrhea > 0
replace in_23103b = f3_2_pct_chn_ort if f3_2_pct_chn_ort > 0
svy: mean in_23103b
...
* MC_IN 2.3.4.1.4 % of latrines that were properly cited

svy: mean in_23413_gsite

* MC_IN 2.3.4.1.4 % of latrines that were in good condition

svy: mean in_23413_gcond
